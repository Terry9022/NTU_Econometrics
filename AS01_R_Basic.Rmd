...
upper<-mean(x.a)+2*sd(x.a)
lower<-mean(x.a)-2*sd(x.a)
x.a<-x.a[(x.a>lower) & (x.a<upper)]
...
quantile(x.a,c(0.25,0.5,0.75))

# 1.4 Get the sequence between 25% to 75% of x.a
x.a[(x.a>quantile(x.a,0.25)) & (x.a>quantile(x.a,0.75))]
...
town[order(population,decreasing = TRUE)]
